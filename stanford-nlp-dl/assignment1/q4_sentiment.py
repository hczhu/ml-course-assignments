...
def getSentenceFeatures(tokens, wordVectors, sentence):
    ...
    sentVector = wordVectors[[tokens[w] for w in sentence]].mean(0)
    # np.zeros((wordVectors.shape[1],))
...
def getRegularizationValues():
    ...
    ### YOUR CODE HERE
    values = [np.power(10.0, 1.0 * x) for x in range(-10, 3)]
    ### END YOUR CODE
